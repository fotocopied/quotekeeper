...
public class SimpleListAdapterBook extends ArrayAdapter<String>{
	...
	private final int image_book[] = {R.drawable.tuesdays, R.drawable.phonecall, R.drawable.fault_star, R.drawable.divergent, R.drawable.mockingbird, R.drawable.pride_prejudice, R.drawable.looking_alaska, R.drawable.dear_john};
	
	
	public SimpleListAdapterBook(Context context, String[] values){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		imageView.setImageResource(image_book[position]);						
